...
def create_nuscenes_infos(
    ...
    # from mmdet3d.datasets.radar_plugin import domain_splits
    ...
    if version == "v1.0-trainval":
        ...
        # val_rainy_scenes = domain_splits.val_rainy
        # val_sunny_scenes = domain_splits.val_sunny
        # val_night_scenes = domain_splits.val_night
        # val_day_scenes = domain_splits.val_day
    ...
    # additional domain splits
    # val_rainy_scenes = list(
    #     filter(lambda x: x in available_scene_names, val_rainy_scenes)
    # )
    # val_sunny_scenes = list(
    #     filter(lambda x: x in available_scene_names, val_sunny_scenes)
    # )
    # val_night_scenes = list(
    #     filter(lambda x: x in available_scene_names, val_night_scenes)
    # )
    # val_day_scenes = list(filter(lambda x: x in available_scene_names, val_day_scenes))
    ...
    # val_rainy_scenes = set(
    #     [
    #         available_scenes[available_scene_names.index(s)]["token"]
    #         for s in val_rainy_scenes
    #     ]
    # )
    # val_sunny_scenes = set(
    #     [
    #         available_scenes[available_scene_names.index(s)]["token"]
    #         for s in val_sunny_scenes
    #     ]
    # )
    # val_night_scenes = set(
    #     [
    #         available_scenes[available_scene_names.index(s)]["token"]
    #         for s in val_night_scenes
    #     ]
    # )
    # val_day_scenes = set(
    #     [
    #         available_scenes[available_scene_names.index(s)]["token"]
    #         for s in val_day_scenes
    #     ]
    # )
...
def _fill_trainval_infos_v2(nusc, train_scenes, val_scenes, test=False, max_sweeps=10):
    ...
    train_scenes_small = list(train_scenes)[:10]
    val_scenes_small = list(val_scenes)[:1]
    samples = []
    for scene in train_scenes_small:
        sample_token = nusc.get("scene", scene)["first_sample_token"]
        while sample_token:
    ...
    for sample in mmcv.track_iter_progress(samples):
        ...
        for cam in camera_types:
            ...
            ##### get 2d and 3d perspective annotations for FCOS3D Head
            # info_2d_list = []
            mono3d = True
            ...
            for coco_info in coco_infos:
                ...
                coco_ann_id += 1
            info["perspective_annotations"].update({cam: coco_infos})
