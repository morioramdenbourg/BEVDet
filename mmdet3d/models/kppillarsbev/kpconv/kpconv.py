...
from mmdetection3d.projects.KPPillarsBEV.kppillarsbev.kpconv.index_select import index_select
from mmdetection3d.projects.KPPillarsBEV.kppillarsbev.kpconv.load_kernels import load_kernels
...
class KPConv(nn.Module):
    ...
    def forward(self, q_points: torch.Tensor, s_points: torch.Tensor, s_feats: torch.Tensor, neighbor_indices: torch.Tensor) -> torch.Tensor:
        """KPConv forward.
        ...
        Args:
            ...
            neighbor_indices (Longtorch.Tensor): (M, H)

        Returns:
            q_feats (torch.Tensor): (M, C_out)
        """
