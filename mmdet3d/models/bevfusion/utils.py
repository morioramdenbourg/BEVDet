...
import torch
from mmdet.core.bbox import (AssignResult, BaseAssigner, BaseBBoxCoder)
...
from mmdet.core.bbox.builder import BBOX_CODERS, BBOX_ASSIGNERS
...
class HeuristicAssigner3D(BaseAssigner):
    ...
    def __init__(self,
        ...
        self.iou_calculator = BBOX_CODERS.build(iou_calculator)
...
class HungarianAssigner3D(BaseAssigner):
    ...
    def __init__(self,
                 ...
                 iou_calculator=dict(type='BboxOverlaps3D')):
        self.cls_cost = MATCH_COST.build(cls_cost)
        self.reg_cost = BBOX_ASSIGNERS.build(reg_cost)
        self.iou_cost = BBOX_ASSIGNERS.build(iou_cost)
