...
from mmdet.core.bbox import (AssignResult, PseudoSampler, build_assigner, build_bbox_coder, build_sampler)
...
from ..builder import MIDDLE_ENCODERS, HEADS, LOSSES
from mmdet.core.bbox.builder import BBOX_ASSIGNERS
from mmdet3d.core import xywhr2xyxyr, circle_nms, draw_heatmap_gaussian, gaussian_radius
...
class TransFusionHead(nn.Module):
    ...
    def __init__(
        ...
        self.loss_heatmap = LOSSES.build(loss_heatmap)
        ...
        for i in range(self.num_decoder_layers):
            self.decoder.append(BBOX_ASSIGNERS.build(decoder_layer))
    ...
    def get_targets_single(self, gt_instances_3d, preds_dict, batch_idx):
        ...
        for idx_layer in range(num_layer):
            ...
            assign_result_list.append(assign_result) # noqa: E501
