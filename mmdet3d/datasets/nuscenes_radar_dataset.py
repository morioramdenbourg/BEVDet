...
class NuScenesRadarDataset(Custom3DDataset):
    r"""NuScenes Dataset.
    ...
    def get_data_info(self, index):
        ...
        if "perspective_annotations" in info:
            input_dict["perspective_annotations"] = info["perspective_annotations"]
    ...
    def get_ann_info(self, index):
        ...
        # lidar2ego_rotation = pyquaternion.Quaternion(lidar2ego_rotation)

        # # convert lidar -> ego for radar
        # gt_bboxes_3d.rotate(lidar2ego_rotation.rotation_matrix)
    ...
    #     """
    #     from nuscenes import NuScenes
    #     from mmdet3d.datasets.radar_plugin.utils_eval import NuScenesEval
    #
    #     output_dir = osp.join(*osp.split(result_path)[:-1])
    ...
    #         distance_bin=None,  # over all ranges
    #     )
    #     nusc_eval.main(plot_examples=10, render_curves=False)
    #
    #     # record metrics
    #     metrics = mmcv.load(osp.join(output_dir, "metrics_summary.json"))
    #     detail = dict()
    ...
    #     all_result_ranges = []
    #     all_ranges = ["all"]
    #     result_dict = metrics["tp_errors"]
    #     result_dict["nd_score"] = metrics["nd_score"]
    #     result_dict["mean_ap"] = metrics["mean_ap"]
    #     all_result_ranges.append(result_dict)
    #
    #     detail["{}/NDS".format(metric_prefix)] = metrics["nd_score"]
    #     detail["{}/mAP".format(metric_prefix)] = metrics["mean_ap"]
    #
    #     if distance_bin:
    #         output_dir = osp.join(*osp.split(result_path)[:-1])
    #         ranges = [[0, 10], [10, 20], [20, 30], [30, 40], [40, 60]]
    #
    #         for current_range in ranges:
    #             range_str = (
    #                 "[ " + str(current_range[0]) + " _ " + str(current_range[1]) + " ]"
    #             )
    #             print()
    #             print(
    #                 "------------------------------------------------------------------------"
    #             )
    #             print("Evaluating distance range:" + range_str)
    #             print(
    #                 "------------------------------------------------------------------------"
    #             )
    #             nusc_eval = NuScenesEval(
    ...
    #                 verbose=True,
    #                 front_view=front_view,
    #                 distance_bin=current_range,  # current range
    #             )
    #             nusc_eval.main(
    #                 plot_examples=0, render_curves=False, range_str=range_str
    #             )
    #
    #             metrics = mmcv.load(
    #                 osp.join(output_dir, range_str + "metrics_summary.json")
    #             )
    #             result_dict = metrics["tp_errors"]
    #             result_dict["nd_score"] = metrics["nd_score"]
    #             result_dict["mean_ap"] = metrics["mean_ap"]
    ...
    #
    #     df_range_evaluation = pd.DataFrame(all_result_ranges, index=all_ranges)
    #     df_range_evaluation.to_csv(osp.join(output_dir, "range_evaluation.json"))
    #     print(df_range_evaluation)
    #
    #     return detail
    ...
    def evaluate_map(self, results):
        ...
        num_classes = results[0]["masks_bev"].shape[0]  # len(self.classes)
        # print(num_classes)
    ...
    #             results_dict = dict()
    #
    #             print("\nEvaluating BEV Segmentation Task!")
    #             results_dict.update(self.evaluate_map(results))
    #             return results_dict
    #
    #         else:
